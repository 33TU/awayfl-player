...
module.exports = (env, { CopyPlugin, HtmlPlugin, typescriptRule, minimizer }) => {
	...
	let plugins = processConfig(config, __dirname, CopyPlugin, HtmlPlugin, fs, rimraf, path);
	...
	prod.optimization = { minimize: true, minimizer: [minimizer] };
...
const processConfig = (config, rootPath, CopyWebPackPlugin, HTMLWebPackPlugin, fs, rimraf, path) => {
